...
msg = MIMEMultipart()
msg['From'] = 'maksibragimov20@gmail.com'
msg['To'] = 'vfrc4748@gmail.com'
...
s.starttls()
s.login('maksibragimov20@gmail.com', 'grabli1577')
s.sendmail('maksibragimov20@gmail.com', 'vfrc4748@gmail.com', msg.as_string())
s.quit()
i = input()